...
os.chdir(data_dir)
lat_file = os.path.join('data', 'Na12500-CF_latitude.dat')
lon_file = os.path.join('data', 'Na12500-CF_longitude.dat')
bin_list = sorted(glob(os.path.join('data', 'bins', '*', 'iceage.grid.week.????.36.n.*.bin')))
