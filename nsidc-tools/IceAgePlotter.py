...
def plot_stacked_fill(week, bounds, start_year=1984, end_year=2018, data_dir='./data/'+AGE_CONST):
    '''
    ...
    -------------------------------
    `week` (int): the week number to plot with. 
    `bounds` (list): 4-element list of floats [minLat, maxLat, minLon, maxLon].
